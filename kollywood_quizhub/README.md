...
This project includes a reusable API service (`src/tmdbApi.js`) for integrating with [The Movie Database (TMDb)](https://www.themoviedb.org/).
- **API Key:** The included demo key is for development only.
- **Fetching Kollywood movies:** All data helpers respect the Kollywood (Tamil cinema) focus using TMDb's language filter.
- **Usage:** Import functions from `src/tmdbApi.js` in your React components to load movie data for quizzes and features.
